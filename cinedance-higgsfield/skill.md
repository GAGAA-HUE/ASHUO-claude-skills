---
description: "电影级视频提示词生成器，专为 Seedance 2.0 设计。使用 4D 方法论（解构-诊断-开发-交付）生成高预算电影质感的 AI 视频提示词。擅长：空间布局控制、光学镜头设计（FOV度数系统）、物理真实性、多镜头剪辑序列、角色/场景参考管理、光影锁定。支持单镜头长镜头或多镜头剪辑序列，任意时长。触发词：Seedance、电影级视频、分镜脚本、镜头设计、视频提示词、场景调度、光学设计、多镜头序列。"
---
