...
- **氛围与画质**：优先写成接近”风格核心 / 视觉基调 / 色彩与影调 / 禁用项”的层次。风格核心写主风格标签 + 情绪关键词；视觉基调尽量补出摄影机型号、镜头系列、拍摄手法、动态模糊设置；色彩与影调尽量补出主色调、对比度、饱和度、光源类型、明暗处理方式、胶片质感；禁用项写明禁止出现的视觉元素。不要只写笼统的电影感。**本段落仅处理场景与整体画面的视觉风格，禁止直接对人物面部/身体进行气质描写（眼神、表情、红晕、气场等）；人物相关的光影与色调必须落到具体的光源方向、面部具体部位、色调物理范围上，避免"眼中带光""脸上发亮""周身笼罩"等让模型误读为特效的表述。**
...
**单条提示词字数边界**：
每个可直接复制给 Seedance 2.0 的成品提示词，字数控制在 1000-5000 字之间。
- 下限 1000：确保内容丰度足够支撑生成稳定性
...
以下术语在 Seedance 2.0 / Sora / Veo / Kling / 可灵 等主流视频生成模型中容易被错误具象化为特效光、光源、变色或物理异常，必须**默认省略或改写为现实物理表述**：

**人物表情类（会被误读为整脸发光/变色）**：
- ❌ 眼神光 / 眼神闪烁 / 眼中泛起 / 眼中泛起涟漪 / 眼中闪烁 / 眼眸泛起泪光 / 眼中泛出 / 瞳孔闪光 / 眼里放光
- ✅ 改写为：光线在瞳孔表面形成细小的反射点 / 眼眶周围有自然湿润反光 / 眼白血丝因情绪充血 / 下眼睑因情绪泛红 / 睫毛投下细密阴影
- ❌ 脸部红晕 / 脸颊泛起红晕 / 脸红得像 / 整张脸通红
- ✅ 改写为：颧骨上方皮下浅层血管因情绪轻微扩张 / 耳根部位皮肤因血流加速轻微泛粉 / 鼻翼两侧轻微发红 / 嘴唇因血液循环加速颜色加深
- ❌ 眼中精光 / 目光如炬 / 眼中带有 / 眼冒金光
- ✅ 改写为：眼神聚焦时眼球转动速度减慢 / 视线长时间锁定某处不偏移 / 眉心因用力而出现微细皱纹

**人物身体反应类（会被误读为异能/特效）**：
- ❌ 周身气场 / 周身散发 / 气场全开 / 杀气 / 霸气外露 / 寒气逼人
- ✅ 改写为：站姿重心下沉 / 肩颈肌肉紧绷 / 呼吸节奏变慢变深 / 手部动作减少至完全静止 / 周围空气流动因体温降低

**光线类（会被误读为画面整体异常）**：
- ❌ 眼里有光 / 眼底发光 / 瞳孔发光 / 眼睛闪着 / 眼中闪着奇异的光芒
- ✅ 改写为：瞳孔表面反射环境光 / 侧光在虹膜边缘形成高光弧 / 眼球湿润层反射的细小光斑
- ❌ 全身散发着 / 周身笼罩 / 周身弥漫
- ✅ 改写为：衣物纹理在侧光下显现 / 皮肤表面有细腻的高光分布 / 周围环境被人物姿态衬托

**核心判断原则**：所有人物相关的"内在气质""情绪反应""精神状态"必须**先翻译为可观测的物理现象**（肌肉收缩、血管扩张、皮肤色调微变、姿态变化、动作节奏变化），再写入提示词。禁止让模型自行从抽象词推断可见画面。
...
21. **现实主义表述原则（强制）**：人物相关的所有”内在状态”（情绪、气质、精神状态、心理活动）必须**先翻译为可观测的物理现象**再写入提示词，包括但不限于：肌肉收缩与松弛、血管扩张引起的皮肤色调微变、呼吸节奏变化、姿态重心转移、动作节奏变化、眼球运动轨迹、嘴角肌肉牵拉方向、眉毛抬起幅度、瞳孔随光线变化的自然收缩。禁止使用任何可能被视频生成模型错误具象化为”特效光””光源””全身变色””眼睛发光””脸部异常色斑”等物理异常的抽象描述（详见”生成模型易误读术语黑名单”）。所有面部与身体反应描述必须基于**真实人体生理反应**，而非文学修辞。
...
□ 变身戏是否写成连续变化而非结果概括？
□ 结尾状态是否明确了最后一秒的画面？
□ **是否包含任何可能被生成模型误读为特效光/光源/变色的术语**（如"眼神光""脸部红晕""眼中泛光""周身散发""气场全开"等）？如有，是否已改写为现实物理表述（肌肉收缩、血管扩张、光线反射点、姿态变化）？
...
【氛围/表情 - 反面】（生成模型易误读为特效）
❌ "海蓝色眼眸中闪过一丝认同的光芒，嘴角微微上扬"
✅ "嘴角颧骨肌轻微收缩带动嘴角上扬约两毫米，海蓝虹膜在侧光下表面反射出细小的弧形高光，眼眶周围皮肤因情绪舒展而略微放松"
❌ "Adrian的淡紫色眼眸微微眯起，眼神带有试探"
✅ "Adrian眉头微微收拢约两毫米，眉心出现微细纵向皱纹，视线方向长时间锁定不偏移，眼轮匝肌轻微收缩使眼裂宽度收窄约三分之一"
❌ "Serena脸颊瞬间染上淡淡的红晕"
✅ "Serena颧骨上方皮下浅层血管因情绪反应轻微扩张，皮肤色调从原本的象牙白加深约一个色阶至带粉的浅米色，变化范围集中在耳根至颧骨区域"
❌ "人物眼中闪着决绝的光芒"
✅ "人物视线长时间锁定某处不偏移，眉头完全压低至眉毛接近眉骨位置，嘴角肌肉紧绷将嘴角向下拉平"

---

## 内部补充：氛围与画质的人物描写边界提示

在"氛围与画质"段落中，禁止直接对人物面部或身体进行抽象气质描写（如"她散发着自信的光芒""他带着温柔的眼神"）。所有人物相关的光影与色调描述必须：
- 写明**光源类型与方向**（侧光、顶光、底光、环境漫反射）
- 写明**光线落在面部的具体部位**（颧骨、鼻梁、眼窝、下颌线）
- 写明**色调变化的物理范围**（皮肤表层、皮下血管反应、衣物反射）
- 避免**让光线成为人物自身的属性**（禁止"眼中带光""脸上发亮""周身笼罩"等）

人物的情绪反应应统一移到"角色设定"与"画面内容"段落，用**动作与肌肉反应**描述，不在"氛围与画质"段落处理。
